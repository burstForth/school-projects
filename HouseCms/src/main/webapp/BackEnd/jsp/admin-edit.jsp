...
<html class="x-admin-sm">
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" action="/HouseCms/user/update" method="post" id="myform">
          ...
          <div class="layui-form-item">
              ...
              <input type="checkbox"
               ...
               <c:if test="${r.rid==ur.rid}">
                 checked="checked"               
               </c:if>
               </c:forEach>
                 lay-skin="primary" title="${r.rname}" value="${r.rid}"  name="rid">
               </c:forEach>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_pass" name="upwd" required="" lay-verify="pass"
