  ...
  <body>
    ...
    <div class="x-body">
      <xblock>
       <shiro:hasPermission name="news:delete">
        ...
        <button class="layui-btn" onclick="x_admin_show('添加品牌','<%=basePath%>BackEnd/jsp/order-add1.jsp')"><i class="layui-icon"></i>添加</button>
        </shiro:hasPermission>
         ...
         <c:forEach items="${lists}" var="m">
          <tr>
           ...
           <td class="td-status">
            ...
            <td class="td-manage">
              <shiro:hasPermission name="news:stastu">
            <a onclick="member_stop(this,'${m.nstatus}','${m.nid}')" href="javascript:;"  title="启用">
                ...
                <shiro:hasPermission name="news:select">
    ...
    <script>
      ...
      function chaxun(currpage,rows){
         ...
         window.location="/HouseCms/news/newfindByPages?currpage="+currpage+"&rows="+rows+"&ntype="+ntype;
      }
      </script>
