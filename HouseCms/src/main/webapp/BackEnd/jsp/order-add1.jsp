...
<html class="x-admin-sm">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/BackEnd/kindeditor/themes/simple/simple.css"/>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" action="/HouseCms/news/add1" id="myform" name="example">
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>新闻名称
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="username" name="nname" required="" lay-verify="required"
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="ntitle" required="" lay-verify="required"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <textarea id="editor_id1" name="ncontent" style="width:700px;height:300px;"></textarea> 
        </div>
          </div>
            ...
            <div class="layui-form-item">
              <label for="L_repass" class="layui-form-label">
               ...
               <input type="s" name="button" value="提交内容" class="layui-btn" lay-filter="add" lay-submit="add"  /> (提交快捷键: Ctrl + Enter)
          </div>
      </form>
    </div>
    <script>
