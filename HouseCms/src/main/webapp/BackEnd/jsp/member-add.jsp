...
<html class="x-admin-sm">
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" action="/HouseCms/brand/add" method="post" id="myform">
          <div class="layui-form-item">
              <label for="L_email" class="layui-form-label">
                  <span class="x-red">*</span>品牌名称
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="L_email" name="bname" required="" lay-verify=""
          ...
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
                  <span class="x-red">*</span>品牌标题
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="L_username" name="btitle" required="" lay-verify=""
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <textarea id="editor_id1" name="bcontent" style="width:700px;height:300px;"></textarea> 
              </div>
