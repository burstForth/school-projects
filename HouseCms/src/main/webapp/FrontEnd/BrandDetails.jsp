...
<body>
	...
	<div id="courses" style="width: 1000px;height: auto;">
		<div id="tname" ><strong>${brand.bname}</strong></div>
		<ul id="time">
		<li>作者：${brand.uname}</li>
		<li>发布时间：${brand.create_time}</li>
		</ul>
		<div id="ttitle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>${brand.btitle}</strong></div>
		<div id="tcontcet">${brand.bcontent}</div>
	</div>
